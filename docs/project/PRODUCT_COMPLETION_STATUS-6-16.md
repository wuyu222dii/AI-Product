...
| v2.2 | 已完成首轮 | 公共官网、登录页、Dashboard、App Shell、工作流页面、响应式与无障碍检查已完成 |
...
| 前端单元测试 | `6` 个通过，覆盖安全返回路径、受保护路由、会话异常恢复、OTP 与 Google OAuth 参数 |
| 前端构建与 smoke | 通过，稳定依赖已拆包，无大 chunk 告警 |
| Playwright | `10` 个通过，覆盖认证、核心流程、桌面/平板/手机和基础无障碍 |
